                    ...
                    <div className='w-[40%]'>
                      ...
                      <div className='flex mt-5'>
                        ...
                        <ul className='w-[50%]'>
                          ...
                          <li className='py-1 px-1 hover:bg-fuchsia-100 transition duration-500 cursor-pointer'>Mules</li>
                    ...
                    <div className='w-[40%]'>
                      ...
                      <div className='flex mt-5'>
                        <ul className='w-[50%]'>
                          ...
                          <li className='py-1 px-1 hover:bg-fuchsia-100 transition duration-500 cursor-pointer'>Gifts</li>
