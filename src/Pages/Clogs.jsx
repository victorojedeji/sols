...
const Clogs = () => {
  ...
  // Filter products based on the category 'clogs'
  const clogProducts = shoeProducts.filter((product) => product.category === 'clogs');
